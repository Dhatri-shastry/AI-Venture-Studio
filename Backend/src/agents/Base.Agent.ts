...
export abstract class BaseAgent {
    ...
    private conversationalGuidelines(): string {
        return [
            ...
            `- If you do NOT have research findings and the question needs real-world current facts you don't actually know (specific local competitors, current pricing, who's currently doing X), say plainly and briefly that you don't have reliable current data on that specific thing - do NOT paper over the gap with a generic strategic framework or a list of places the founder could go look. A short honest "I don't have real data on that" beats a long confident-sounding generic answer.`,
...
${investorBlock}Relevant things you can draw on if they fit the conversation (don't force all of them into one reply, and don't turn this into a checklist):
